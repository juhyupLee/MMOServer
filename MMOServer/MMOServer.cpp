...
#if MEMORYLOG_USE ==1 
    IOCP_Log log;
    log.DataSettiong(InterlockedIncrement64(&g_IOCPMemoryNo), eIOCP_LINE::MESSAGE_MARSHAL, GetCurrentThreadId(), _Socket, _IOCount, (int64_t)this, _ID, (int64_t)&_RecvOL, (int64_t)&_SendOL, _SendFlag, (int32_t)2, -1, (eRecvMessageType)type, -1);
